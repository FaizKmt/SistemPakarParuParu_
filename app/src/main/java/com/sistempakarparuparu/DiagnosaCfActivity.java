...
public class DiagnosaCfActivity extends AppCompatActivity {
    ...
    private static final String url = "https://sistempakarparu1.000webhostapp.com/get_daftar_gejala.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Diagnosa Penyakit Paru-Paru");
        ...
        diagnosa.setOnClickListener(view -> {
            if (hasil.size() >= 4) {
                ...
                Toast.makeText(this, "Pilih minimal 4 gejala terlebih dahulu", Toast.LENGTH_SHORT).show();
            }
