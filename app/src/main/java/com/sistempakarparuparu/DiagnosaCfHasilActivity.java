...
public class DiagnosaCfHasilActivity extends AppCompatActivity {
    ...
    private static final String url = "https://sistempakarparu1.000webhostapp.com/get_hasil_cf.php";
    private String hasil;
    private Button btn_penyakit;
    private Button btn_konsultasi;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_konsultasi = findViewById(R.id.btn_konsultasi);
        ...
        btn_konsultasi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // Arahkan ke halaman login saat tombol konsultasi ditekan
                Intent intent = new Intent(DiagnosaCfHasilActivity.this, LoginActivity.class);
                    ...
                    try {
                        if (response.getInt("status") == 0) {
                            if (response.getString("id_penyakit").equals("")) {
                                ...
                                // Mengambil nilai sebagai int, kemudian mengonversinya menjadi string
                                int nilaiInt = (int) Double.parseDouble(response.getString("nilai"));
                                String nilaiString = String.valueOf(nilaiInt);
