...
public class PenyakitDetailActivity extends AppCompatActivity {
    ...
    private static final String url = "https://sistempakarparu1.000webhostapp.com/get_penyakit.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        diagnosaulang = findViewById(R.id.diagnosaulang);
        diagnosaulang.setOnClickListener(v -> startDiagnosaCfActivity());
    ...
    private void startDiagnosaCfActivity() {
        Intent intent = new Intent(PenyakitDetailActivity.this, DiagnosaCfActivity.class);
