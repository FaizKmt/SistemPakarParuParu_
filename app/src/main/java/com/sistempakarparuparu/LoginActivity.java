...
public class LoginActivity extends AppCompatActivity {
                    ...
                    try {
                        if (response.getInt("status") == 0) {
                            ...
                            if (response.getString("level").equals("Admin")) {
                                Intent i = new Intent(getApplicationContext(), SessionHandler.class);
                                startActivity(i);
                                finish();
                            } else {
                                // Panggil metode untuk membuka Telegram sesuai dengan perangkat
    ...
    private void openTelegram(String userLevel) {
        ...
        String telegramUri = "https://t.me/Widow_Seeker_Bot"; // Ganti dengan username Telegram yang diinginkan
