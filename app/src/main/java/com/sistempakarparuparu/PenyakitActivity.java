...
public class PenyakitActivity extends AppCompatActivity {
    ...
    private static final String url = "https://sistempakarparu1.000webhostapp.com/get_daftar_penyakit.php";
    private ListView lv;
                    ...
                    try {
                        if (response.getInt("status") == 0) {
                            ...
                            AdapterView.OnItemClickListener itemClickListener = (parent, container, position, id) -> {
                                ...
                                Intent intent = new Intent(PenyakitActivity.this, PenyakitDetail.class);
